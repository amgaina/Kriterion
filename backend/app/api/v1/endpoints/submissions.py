...
async def create_submission(
    ...
    notify_users(
        ...
        message=f"{current_user.full_name or current_user.email} submitted attempt {attempt_number} in {assignment.course.code}.",
        course_id=assignment.course_id,
...
async def grade_submission(
    ...
    try:
        ...
        create_notification(
            ...
            message=f"Your submission for '{submission.assignment.title}' in {submission.assignment.course.code} was graded. Score: {submission.final_score if submission.final_score is not None else 'available in gradebook'}.",
