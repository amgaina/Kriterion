...
export default function FacultyAssignmentsPage() {
    ...
    const deleteMutation = useMutation({
        ...
        onSuccess: () => queryClient.invalidateQueries({ queryKey: ['assignments', 'faculty'] }),
    });
            ...
            cell: (assignment: Assignment) => (
                <Dropdown
                    ...
                    onSelect={(value) => {
                        ...
                        else if (value === 'edit') window.location.href = `/faculty/assignments/${assignment.id}/edit`;
                        else if (value === 'submissions') window.location.href = `/faculty/assignments/${assignment.id}/submissions`;
                    }}
                    align="right"
                />
            ),
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div>
                            ...
                            <p className="text-gray-500 mt-1">Create and manage programming assignments for your courses</p>
                        </div>
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xl font-bold text-blue-600">
                                            {assignments.length > 0 ? Math.round(assignments.reduce((acc: number, a: Assignment) =>
                                                acc + (a.submission_count || 0), 0) / (assignments.length)) : 0}
                                        </p>
                                    </div>
                                </div>
                            </CardContent>
