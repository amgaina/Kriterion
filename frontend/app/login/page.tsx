                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    autoComplete="email"
                                    {...register('email')}
                                    className={`w-full bg-white border rounded-xl px-4 py-3 text-sm text-gray-900 placeholder:text-gray-400 focus:outline-none transition-all ${errors.email
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        {...register('password')}
                                        className={`w-full bg-white border rounded-xl px-4 py-3 pr-11 text-sm text-gray-900 placeholder:text-gray-400 focus:outline-none transition-all ${errors.password
                                                ? 'border-red-300 focus:border-red-400 focus:ring-2 focus:ring-red-100'
                                                : 'border-gray-200 focus:border-primary/40 focus:ring-2 focus:ring-primary/10'
                                            }`}
